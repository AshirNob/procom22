...
<body>
    <header class="header">
        <div>
            ...
            <a href="sprint-meeting" class="btn btn-theme-2">Sprint Meeting</button>
        </div>
        <div>
            <a href="my-boards" class="btn btn-theme rounded-pill" title="Your Boards"><i class="fas fa-home"></i></a>
        </div>
    </header>
    <div class="">
