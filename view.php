...
<body>
    <header class="header">
        <div>
            <a href="my-boards" class="logo">Team<span>X</span></a>
           
        </div>
        <div>
            <a href="my-boards" class="btn btn-theme rounded-pill" title="Your Boards"><i class="fas fa-clipboard"></i></a>
            <a href="functions?logout=1" class="btn btn-theme ml-3" title="Your Boards"><i class="fas fa-sign-out-alt"></i> Logout</a>
        </div>
    </header>
    <div class="">
                ...
                <div class="row">
                    <div class="col-md-9 mx-auto login-form">
                        <div class="form-section">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="h6">List - <a href="board?bid=<?=$board_id?>">
                            ...
                            <form>
                                ...
                                <div class="col-lg-2 col-md-3 col-4 ml-auto text-right">
                                    <a href="board?bid=<?=$board_id?>" class="btn d-block btn-theme-2 text-danger px-2">Back</a>
                                </div>
                            </form>
...
function update_member(cid,uid){
    $.ajax({
        ...
        success:function (res){
           window.location.href="board?bid=<?=$board_id?>";
        }
    });
}
